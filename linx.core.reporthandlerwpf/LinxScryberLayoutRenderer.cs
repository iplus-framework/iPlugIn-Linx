...
namespace linx.core.reporthandlerwpf
{
    ...
    /// </summary>
    public sealed class LinxScryberLayoutRenderer : IDocumentLayoutRenderer
    {
        private readonly Encoding _encoding;
        private readonly List<LinxScryberRenderedLine> _lines = new List<LinxScryberRenderedLine>();
        private LinxScryberJobMetadata _jobMetadata = new LinxScryberJobMetadata();

        public IReadOnlyList<LinxScryberRenderedLine> Lines => _lines;
        public LinxScryberJobMetadata JobMetadata => _jobMetadata;

        public LinxScryberLayoutRenderer(Encoding encoding)
        {
        ...
        private void WriteLine(Stream output, PDFLayoutLine line)
        {
            ...
            foreach (LinxScryberRenderedLine rendered in ExtractRenderedLines(line))
            {
        ...
        private static List<LinxScryberRenderedLine> ExtractRenderedLines(PDFLayoutLine line)
        {
            List<LinxScryberRenderedLine> results = new List<LinxScryberRenderedLine>();
        ...
        private LinxScryberJobMetadata ExtractJobMetadata(ScryberDocument document)
        {
            LinxScryberJobMetadata result = new LinxScryberJobMetadata();
            if (document == null)
                return result;
        ...
        private static void ApplyJobMetadataById(ScryberDocument document, string id, LinxScryberJobMetadata target)
        {
        ...
        private static void ApplyJobMetadataFromComponent(Component component, LinxScryberJobMetadata target)
        {
        ...
        private static void AddRenderedLine(List<LinxScryberRenderedLine> results, string text, string aggregateGroup, int xPos, int yPos)
        {
            ...
            results.Add(new LinxScryberRenderedLine
            {
                Text = trimmed,
    ...
    public sealed class LinxScryberRenderedLine
    {
    ...
    public sealed class LinxScryberJobMetadata
    {
